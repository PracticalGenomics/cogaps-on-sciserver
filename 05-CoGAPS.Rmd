...
ottrpal::include_slide("https://docs.google.com/presentation/d/16jh1ov1PyRyPKMTJ7ROiEyNm1B5KxdQlYQovVBCYesk/edit#slide=id.g25a927a7c80_0_63")
```
...
```{r, fig.alt="Image of the Compute page with the RStudio compute image highlighted", out.width = "100%", echo = FALSE}
ottrpal::include_slide("https://docs.google.com/presentation/d/16jh1ov1PyRyPKMTJ7ROiEyNm1B5KxdQlYQovVBCYesk/edit#slide=id.g25a927a7c80_0_69")
```

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; c. Click "**Create**". This may take a moment.

```{r, fig.alt="Image of the Compute page with the Create button highlighted", out.width = "100%", echo = FALSE}
ottrpal::include_slide("https://docs.google.com/presentation/d/16jh1ov1PyRyPKMTJ7ROiEyNm1B5KxdQlYQovVBCYesk/edit#slide=id.g25a927a7c80_0_74")
```

4. You should now see a new entry in your list of containers.

```{r, fig.alt="Image of the Compute page with arrows pointing to the date/time of container's creation, its name, and the container image", out.width = "100%", echo = FALSE}
ottrpal::include_slide("https://docs.google.com/presentation/d/16jh1ov1PyRyPKMTJ7ROiEyNm1B5KxdQlYQovVBCYesk/edit#slide=id.g25a927a7c80_0_81")
```
...
```{r, fig.alt="Image of the Compute page with the container name highlighted", out.width = "100%", echo = FALSE}
ottrpal::include_slide("https://docs.google.com/presentation/d/16jh1ov1PyRyPKMTJ7ROiEyNm1B5KxdQlYQovVBCYesk/edit#slide=id.g25a927a7c80_0_89")
```
...
ottrpal::include_slide("https://docs.google.com/presentation/d/16jh1ov1PyRyPKMTJ7ROiEyNm1B5KxdQlYQovVBCYesk/edit#slide=id.g25a927a7c80_0_95")
```
...
```{r, fig.alt="Image of the red STOP sign in RStudio, indicating that installation is still in progress", out.width = "100%", echo = FALSE}
ottrpal::include_slide("https://docs.google.com/presentation/d/16jh1ov1PyRyPKMTJ7ROiEyNm1B5KxdQlYQovVBCYesk/edit#slide=id.g25a927a7c80_0_102")
```

```{r, fig.alt="Image of the red STOP sign no longer visible in RStudio, indicating that installation is complete", out.width = "100%", echo = FALSE}
ottrpal::include_slide("https://docs.google.com/presentation/d/16jh1ov1PyRyPKMTJ7ROiEyNm1B5KxdQlYQovVBCYesk/edit#slide=id.g25a927a7c80_0_109")
```
...
ottrpal::include_slide("https://docs.google.com/presentation/d/16jh1ov1PyRyPKMTJ7ROiEyNm1B5KxdQlYQovVBCYesk/edit#slide=id.g25a5f9f2e31_0_1")
```
...
```{r, fig.alt="Image of the CoGAPS Guide website homepage", out.width = "100%", echo = FALSE}
ottrpal::include_slide("https://docs.google.com/presentation/d/16jh1ov1PyRyPKMTJ7ROiEyNm1B5KxdQlYQovVBCYesk/edit#slide=id.g25954290abf_0_8")
```

[CoGAPS R Guide](https://fertiglab.github.io/CoGAPSGuide/proceduretwo/)

```{r, fig.alt="Image of the R CoGAPS API page", out.width = "100%", echo = FALSE}
ottrpal::include_slide("https://docs.google.com/presentation/d/16jh1ov1PyRyPKMTJ7ROiEyNm1B5KxdQlYQovVBCYesk/edit#slide=id.g25a927a7c80_0_116")
```
